...
function Spotify (pingPongServerUrl) {
  ...
  this.pingPongServerUrl = pingPongServerUrl || "http://spflash.herokuapp.com/generic/get";
...
/**
 * Gets user account informations from Spotify
*/

Spotify.prototype.fetchUserInfos = function(fn) {
  if (this.listeners('login').length === 0) this._setLoginCallbacks(fn);
